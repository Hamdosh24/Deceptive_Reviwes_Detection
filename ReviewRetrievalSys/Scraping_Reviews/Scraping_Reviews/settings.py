...
BOT_NAME = "Scraping_Reviews"

SPIDER_MODULES = ["Scraping_Reviews.spiders"]
NEWSPIDER_MODULE = "Scraping_Reviews.spiders"
...
DOWNLOADER_MIDDLEWARES = {
    'Scraping_Reviews.middlewares.RandomUserAgentMiddleware': 543,
